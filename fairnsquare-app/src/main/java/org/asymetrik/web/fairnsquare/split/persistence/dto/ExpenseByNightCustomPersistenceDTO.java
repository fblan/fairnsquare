...
/**
 * Persistence DTO for ExpenseByNightCustom domain object. Stores the list of participating participant IDs. Shares are
 * not persisted — they are recalculated from participant nights on load.
 */
