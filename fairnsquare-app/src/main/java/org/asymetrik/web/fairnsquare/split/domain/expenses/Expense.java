...
public sealed abstract class Expense
    ...
    public static Expense create(BigDecimal amount, String description, Participant.Id payerId, SplitMode splitMode) {
        ...
        return switch (splitMode) {
            ...
            case BY_NIGHT_CUSTOM -> throw new UnsupportedOperationException(
                    "BY_NIGHT_CUSTOM mode requires participantIds - use ExpenseByNightCustom.create(amount, description, payerId, participantIds)");
        };
    }
    ...
    public static Expense fromJson(Id id, BigDecimal amount, String description, Participant.Id payerId,
        ...
        return switch (mode) {
            ...
            case BY_NIGHT_CUSTOM -> throw new UnsupportedOperationException(
                    "BY_NIGHT_CUSTOM mode requires participantIds - use ExpenseByNightCustom.fromJson(id, amount, description, payerId, participantIds, createdAt)");
        };
    }
